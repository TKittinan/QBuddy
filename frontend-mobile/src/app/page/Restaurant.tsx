...
export default function Restaurant() {
  ...
  const filteredPlaces = useMemo(() => {
    ...
    return allPlaces.filter((place: any) => 
  ...
  return (
    <SafeAreaView style={styles.safeArea}>
      ...
      <View style={styles.searchPadding}>
        <View style={styles.searchMinimalWrapper}>
          ...
          <TextInput 
            ...
            placeholder="ค้นหาร้านที่คุณอยากกิน..." 
      ...
      <View>
        <ScrollView horizontal showsHorizontalScrollIndicator={false} style={styles.chipScroll}>
          <TouchableOpacity style={styles.chipActive}>
            ...
            <Text style={styles.chipTextActive}>ร้านอาหาร</Text>
          </TouchableOpacity>
      ...
      <FlatList
        ...
        ListEmptyComponent={<Text style={styles.emptyText}>ไม่พบร้านอาหารที่ค้นหา</Text>}
